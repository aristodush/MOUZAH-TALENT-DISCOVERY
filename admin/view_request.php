                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT users.*, users_requests.* FROM users INNER JOIN users_requests ON users.u_id=users_requests.u_id where o_id='".$_GET['user_upd']."'";
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('request_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">

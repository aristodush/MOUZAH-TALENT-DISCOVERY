...
(function(global, factory) {
  ...
  function(_jquery) {
    ...
    for (var i = 0; i < vendors.length && !window.orderAnimationFrame; ++i) {
      var vp = vendors[i];
      window.orderAnimationFrame = window[vp + 'orderAnimationFrame'];
      window.cancelAnimationFrame = window[vp + 'CancelAnimationFrame'] || window[vp + 'CancelorderAnimationFrame'];
    }

    if (/iP(ad|hone|od).*OS (6|7|8)/.test(window.navigator.userAgent) || !window.orderAnimationFrame || !window.cancelAnimationFrame) {
      (function() {
        var lastTime = 0;
        window.orderAnimationFrame = function(callback) {
          var now = getTime();
          var timePlus = 16;
            ...
            (function() {
              ...
              var run = function run(time) {
                ...
                if (percent === 1) {
                  ...
                  _this3._frameId = window.orderAnimationFrame(run);
                }
              };

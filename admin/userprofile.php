...
$sql=mysqli_query($db,"update users_requests set status='$status' where o_id='$form_id'");
...
$ret1=mysqli_query($db,"select * FROM users_requests where o_id='".$_GET['newform_id']."'");

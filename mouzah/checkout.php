...
if(empty($_SESSION["user_id"]))
{
	header('location:login.php');
												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													$SQL="insert into users_requests(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";

														mysqli_query($db,$SQL);

														$success = "Thankyou! Your order Placed successfully!";
														header("refresh:0;url=your_requests.php");
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#">Pick Your favorite mouzah</a></li>
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
																				...
																				Or Use PayPal
																					...
																					<input type="hidden" name="item_name_1" value="mouzah ordering">
																					<input type="hidden" name="amount_1" value="<?php echo $item_total/1000; ?>">


																					<input class="btn btn-outline-success btn-block" type="submit" value="PayPal">
																					</form>

         ...
         <div class="page-wrapper">
            ...
            <section class="contact-page inner-page">
               <div class="container">
                  ...
                  <h1> <center> Hiring Form </center></h1>
                  <hr>
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                       <label for="exampleInputEmail1">Company Name</label>
                                       <input class="form-control" type="text" name="username" id="example-text-input" placeholder="Company Name" minlength="4"  required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Tin number</label>
                                       <input class="form-control" type="text" name="firstname" id="example-text-input" placeholder="Tin number" minlength="4" required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Representative Name</label>
                                       <input class="form-control" type="text" name="lastname" id="example-text-input-2" placeholder="Representative Name" minlength="4" required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-12">
                                       <label for="exampleInputPassword1">Proof of registration</label>

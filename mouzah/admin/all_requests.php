                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT users.*, users_requests.* FROM users INNER JOIN users_requests ON users.u_id=users_requests.u_id ";
																			...
																			?>
																						<?php
																							...
																							?>
																								...
																								<?php
																								echo '<a href="view_request.php?user_upd='.$rows['o_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';
